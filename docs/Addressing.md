...
| --------------- | ---------------------------------- | ----------------- |
| 10.0.0.0/24     | Pod CIDR                           | Chaos Cilium Node |
| 10.20.0.0/16    | Pod CIDR                           | Chaos             |
...
Chaos appears to be using a cluster pod CIDR of 10.20.0.0/16. However, it is not strictly controlled.
